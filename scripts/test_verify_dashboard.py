...
class DashboardGuardTest(unittest.TestCase):
    ...
    def test_public_html_contains_approved_sanitized_weekly_content(self):
        ...
        self.assertIn('.team .hd2{position:relative;display:block;min-height:84px;padding-right:98px}', self.html)
        self.assertIn('.team .achv{--p:0;--achv-ring:var(--violet);--achv-track:#E8EDF3;position:absolute;top:0;right:0;width:84px;height:84px', self.html)
        ...
        self.assertIn('<span class="achv up num" data-achievement-ring="달성" style="--p:100" role="img" aria-label="달성률 100.3%"><span class="achv-in"><b>100.3%</b><small>달성률</small>', self.html)
        self.assertIn('<span class="achv dn num" data-achievement-ring="달성" style="--p:14.5" role="img" aria-label="달성률 14.5%"><span class="achv-in"><b>14.5%</b><small>달성률</small>', self.html)
