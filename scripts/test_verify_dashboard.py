...
class DashboardGuardTest(unittest.TestCase):
    ...
    def test_public_html_contains_approved_sanitized_weekly_content(self):
        ...
        self.assertIn('.team .hd2{display:flex;justify-content:space-between;align-items:flex-start;gap:14px;min-height:58px}', self.html)
        self.assertIn('.team .achv{--p:0;--achv-ring:var(--violet)', self.html)
